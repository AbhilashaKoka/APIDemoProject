...
public class BookStoreEndToEndAPITestNGTest {
    ...
    @Test(enabled = true,description = "Verify Create User")
    public void VerifyCreateUser() throws IOException {
          ...
          authorizationRequest=new AuthorizationRequest(username, password);
    ...
    public boolean VerifyBooksOfUser() throws IOException {
        ...
        @Test(description = "Verify get User",enabled  = false,dependsOnMethods = {"VerifyCreateUser","VerifyGenerateToken","VerifyUserAuthorized"})
    ...
    @Test(description = "Verify get Books", enabled  = false,dependsOnMethods = {"VerifyCreateUser","VerifyGenerateToken","VerifyUserAuthorized"})
    ...
    @Test(description = "Verify Get book by ISBN",enabled = false)
   ...
   @Test(description = "Verify update books by  UserID and ISBN",enabled = false)
...
@Test(description = "Verify Delete Book",enabled = false)
