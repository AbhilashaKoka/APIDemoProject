...
public class SliderPage {
    ...
    @FindBy(how= How.XPATH,using="//*[@class=\"accordion\"]//div[@class=\"element-group\"]//following::span[@class=\"text\" and contains(text(),\"Slider\")]")
    private WebElement  Slider_span;

    public void SliderPage(WebDriver driver) {
        this.driver = driver;
